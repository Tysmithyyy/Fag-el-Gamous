    ...
    public partial class gamousContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=aam7gxxxne51of.chjpza0zaptm.us-east-1.rds.amazonaws.com,1433;Initial Catalog=gamous;User ID=admin;Password=Admin!11;");
            }
        }
